...
public class NotificationDirectoryResource extends DirectoryResource<Notification, APINotification> {
     ...
     */
    @AssistedInject
    public NotificationDirectoryResource(
            ...
            DirectoryObjectResourceFactory<Notification, APINotification> resourceFactory) {
        super(authenticatedUser, userContext, Notification.class, directory, translator, resourceFactory);
    }
